...
export default function Register() {
  ...
  useEffect(() => {
    if (response?.type === "success") {
      ...
      // TODO:
      // 1) Gọi backend để trao đổi token (khuyên dùng) hoặc
      // 2) Gọi Graph API user info: https://graph.facebook.com/me?fields=id,name,email&access_token=...
      // Sau khi có user -> điều hướng:
  ...
  return (
    <View className="flex-1 bg-background">
      ...
      <View className="flex px-6 pt-10 items-center">
        ...
        <TouchableOpacity className="w-[80%] bg-yellow py-4 rounded-full items-center">
